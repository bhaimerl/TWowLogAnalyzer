            ...
            for (String huterName : hunters) {
                Hunter hunter= hunterMap.get(huterName);
                    strBuf.append("<tr>")
                          ...
                          .append("<td class=\"toggle-column-highlights\">").append(hunter.getHighestAutoShot()).append(" => ").append(hunter.getHighestAutoShotTarget()).append("</td>")
                          .append("<td>").append(hunter.getSteadyShotHits()).append(" / ").append(hunter.getSteadyShotCrits()).append("</td>")
                          .append("<td class=\"toggle-column-highlights\">").append(hunter.getHighestSteadyShot()).append(" => ").append(hunter.getHighestSteadyShotTarget()).append("</td>")
                          .append("<td>").append(hunter.getMultiShotHits()).append(" / ").append(hunter.getMultiSHotCrits()).append("</td>")
                          .append("<td class=\"toggle-column-highlights\">").append(hunter.getHighestMultiShot()).append(" => ").append(hunter.getHighestMultiShotTarget()).append("</td>")
                          .append("<td>").append(hunter.getArcaneShotHits()).append(" / ").append(hunter.getArcaneShotCrits()).append("</td>")
                          .append("<td class=\"toggle-column-highlights\">").append(hunter.getHighestArcaneShot()).append(" => ").append(hunter.getHighestArcaneShotTarget()).append("</td>")
                          .append("<td>").append(hunter.getExtraShotHits()).append(" / ").append(hunter.getExtraShotCrits()).append("</td>")
                          .append("<td class=\"toggle-column-highlights\">").append(hunter.getHighestExtraShot()).append(" => ").append(hunter.getHighestExtraShotTarget()).append("</td>")
                          .append("<td>").append(hunter.getAimedShotHits()).append(" / ").append(hunter.getAimedShotCrtis()).append("</td>")
                          .append("<td class=\"toggle-column-highlights\">").append(hunter.getHighestAimedShot()).append(" => ").append(hunter.getHighestAimedShotTarget()).append("</td>")
